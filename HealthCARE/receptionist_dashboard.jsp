...
<html lang="en">
<head>
    <% request.setAttribute("receptionist_dashboard",true); %>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="css/receptionist_dashboard.css" />
                    ...
                    <div class="row record_box">
                        <div class="container">
                            <div class="headerText text-center welcm">
                                <h1 ><br />Welcome <span>Receptionist</span> !!!</h1>
                            </div>
                            <br />
