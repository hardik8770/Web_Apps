...
<html lang="en">
<head>
        <% request.setAttribute("doctor_dashboard",true); %>
        <meta charset="UTF-8">
                    ...
                    <div class="row record_box">
                        <div class="container">
                            <div class="headerText text-center welcm">
                                <h1 ><br />Welcome <span>Doctor</span> !!!</h1>
                            </div>
                            <br />
                            <div class="col-lg-12" data-aos="fade-up" data-aos-duration="300" data-aos-delay="300">
                                ...
                                <button type="button" class="btn btn-success adminbtn ad3" id="see_btn" data-toggle="modal" data-target="#exampleModalScrollableManageAppointment">
                                   See Appointments
                                </button>
