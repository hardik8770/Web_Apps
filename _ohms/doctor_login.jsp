                    ...
                    <div class="row login_box">
                        <div class="col-sm-12">
                            <div class="headerText text-center welcm">
                                <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300"><br />Welcome <span>Doctor</span> !!!</h1>
