...
var manageBtn, patientRequest, patientAppend,closeBtn,patientId=1,deletePatientReq;

function getAllElements() {
    manageBtn = document.getElementById('manage_btn');
    patientAppend = document.getElementById('patient_records_append');
...
function collectPatient(){
    ...
    patientRequest.open('get','collect_patient.do',true);
